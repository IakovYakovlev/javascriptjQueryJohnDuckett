/* Данный сценарий находится внутри функции-выражения, вызываемой сразу после создания. Это делается для защиты области выдимости переменных. */
...
(function() {
  ...
  var elEnds;       // Элемент, в котором отобраается сообщение об окончании акции
  ...
  today = new Date();                               // Записываем согодняшнюю дату в переменную
