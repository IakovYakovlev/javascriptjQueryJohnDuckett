...
list.appendChild(newItemLast);                                        // Добавялем элемент к концу списка
...
// ДОБАВЛЯЕМ В ЗАГОЛОВОК ИНФОРМАЦИЮ О КЛИЧЕСТВЕ ЭЛЕМЕНТОВ В СПИСКЕ
...
heading.innerHTML = newHeading;                                       // Обновляем h2 (не textContent) т.к. есть разметка
